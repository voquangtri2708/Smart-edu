            ...
            <form @submit.prevent="saveProfile">
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  ...
                  <input type="email" class="form-control" v-model="editedStudent.email" :disabled="!isEditing">
                </div>
                <div class="col-md-6">
                  <label class="form-label">Số điện thoại</label>
                  <input type="tel" class="form-control" v-model="editedStudent.phone_number" :disabled="!isEditing">
                </div>
              </div>
